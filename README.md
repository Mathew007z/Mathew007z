...
Me apasiona lo que hago, por eso sigo aprendiendo dia a dia. Actualmente soy desarrollador Front-end (HTML, CSS , JS Y REACT JS) , y actualmente estoy cursando Backend con base de datos NoSQL con Mongodb y el framework Express.
</h3>
</div>
